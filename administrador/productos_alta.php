...
$(document).ready(function() {
        ...
        if (codigo) {
            $.ajax({
                ...
                success: function(response) {
                    if (response.trim() === '1') {
                        $('#email-error').text('El codigo ya está registrado.').show();
                        $('#enviar').prop('disabled', true); 
                        codigoWithError = codigo; 
                        ...
                        codigoWithError = ''; // Resetea el correo con error
                    }
                },
                error: function() {
    ...
    $('#enviar').on('click', function(event) {
        ...
        if (codigo === codigoWithError) {
            event.preventDefault(); // Evita el envío del formulario
            $('#email-error').text('El codigo ya está registrado.').show(); // Muestra el mensaje de error
...
<body>
    ...
    <div class="form-container">
        <form id="altaProducto" method="POST" action="productos_salva.php" enctype="multipart/form-data">
