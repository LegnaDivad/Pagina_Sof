...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    $query = "SELECT nombre, archivo  FROM promociones WHERE id = ?";
    ...
    echo "ID de promocion no proporcionado o no válido.";
    exit;
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Detalle del promocion</title>
    <style>
        .btn-regresar {
...
<body>
    ...
    <div class="container">
        ...
        <div class="profile-image">
            ...
            <img src="fotosPromociones/<?php echo $promocion['archivo']; ?>">
        ...
        <div class="field">
            <label>Nombre:</label>
            <span><?php echo htmlspecialchars($promocion['nombre']); ?></span>
        </div>
